...
export const brands = ["Nike", "Adidas", "New Balance", "Converse", "Vans", "Puma"];

export const sizes = ["230", "235", "240", "245", "250", "255", "260", "265", "270", "275", "280"];

export const sortOptions = ["인기순", "가격 높은순", "가격 낮은순", "최신순"];
